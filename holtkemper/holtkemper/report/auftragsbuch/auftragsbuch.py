...
def get_columns():
    return [
        ...
        {"label": _("Belegsumme"), "fieldname": "base_grand_total", "fieldtype": "Currency", "width": 90},
        {"label": _("Rechg-Nr.:"), "fieldname": "sales_invoice", "fieldtype": "Link", "options": "Sales Invoice", "width": 85},
        {"label": _("Liefers-Nr.:"), "fieldname": "delivery_note", "fieldtype": "Link", "options": "Delivery Note", "width": 75},
        {"label": _("Auftrag-Nr.:"), "fieldname": "sales_order", "fieldtype": "Link", "options": "Sales Order", "width": 85},
        ...
        {"label": _("FL 30042"), "fieldname": "fl30042", "fieldtype": "Float", "precision": 2, "width": 70},
        {"label": _("FL 33969"), "fieldname": "fl33969", "fieldtype": "Float", "precision": 2,  "width": 70},
        {"label": _("FL 38141"), "fieldname": "fl38141", "fieldtype": "Float", "precision": 2, "width": 70},
        {"label": _("FL 39228"), "fieldname": "fl39228", "fieldtype": "Float", "precision": 2, "width": 70},
        {"label": _("offen"), "fieldname": "offen", "fieldtype": "Currency", "width": 85},
        {"label": _("Fremd"), "fieldname": "fremd", "fieldtype": "Float", "precision": 2, "width": 65},
        {"label": _("Aufwand"), "fieldname": "aufwand", "fieldtype": "Float", "precision": 2, "width": 65},
